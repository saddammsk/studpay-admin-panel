     ...
     return (
          <div className="font-inter">
               <div className="grid xl:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-4 mb-6">
                    <div className="bg-white border border-solid border-gray-1000 rounded-xl shadow-9xl p-5 flex items-center justify-between">
                         <div className="">
                              ...
                              <h2 className="text-blue-1300 text-2xl font-bold leading-8">24</h2>
                         </div>
                    ...
                    <div className="bg-white border border-solid border-gray-1000 rounded-xl shadow-9xl p-5 flex items-center justify-between">
                         <div className="">
                              ...
                              <h2 className="text-blue-1300 text-2xl font-bold leading-8">87.5%</h2>
                         </div>
                    ...
                    <div className="bg-white border border-solid border-gray-1000 rounded-xl shadow-9xl p-5 flex items-center justify-between">
                         <div className="">
                              ...
                              <h2 className="text-blue-1300 text-2xl font-bold leading-8">€18,900</h2>
                         </div>
                    ...
                    <div className="bg-white border border-solid border-gray-1000 rounded-xl shadow-9xl p-5 flex items-center justify-between">
                         <div className="">
                              ...
                              <h2 className="text-blue-1300 text-2xl font-bold leading-8">3</h2>
                         </div>
               ...
               <div className="grid md:grid-cols-2 grid-cols-1 gap-6">
                    <div className="bg-white  border border-solid border-gray-3600 rounded-[14px] shadow-10xl p-6">
                         <div className="flex items-center justify-between border-b border-solid border-gray-1000">
                              <h4 className="text-blue-1300 font-inter font-bold text-lg leading-7 pb-4">Property Summary</h4>
                              <Image
                    ...
                    <div className="bg-white border border-solid border-gray-3600 rounded-[14px] shadow-10xl p-6">
                         <div className="flex items-center justify-between border-b border-solid border-gray-1000">
                              <h4 className="text-blue-1300 font-inter font-bold text-lg leading-7 pb-4">Owner Information</h4>
                              <Image
                         ...
                         <div className="pt-4">
                              <div className="max-w-140 w-full grid grid-cols-2 gap-y-4 mb-4">
                                   ...
                                   <div className="">
                                        ...
                                        <h4 className="text-blue-1300 font-inter font-normal text-sm leading-5">Hans Müller</h4>
                                   </div>
                                   <div className="">
                                   ...
                                   <div className="">
                                        ...
                                        <h4 className="text-blue-1300 font-inter font-normal text-sm leading-5">h.mueller@bsh-berlin.de</h4>
                                   </div>
                                   <div className="">
                                        <span className="text-gray-1200 font-inter font-normal text-xs leading-4 mb-1 tracking-[0.3px] block">Phone</span>
                                        <h4 className="text-blue-1300 font-inter font-normal text-sm leading-5">+49 30 1234567</h4>
                                   </div>
               ...
               <div className="bg-white mt-6 border border-solid border-gray-3600 rounded-[14px] shadow-10xl p-6">
                    <div className="flex items-center justify-between border-b border-solid border-gray-1000">
                         <h4 className="text-blue-1300 font-inter font-bold text-lg leading-7 pb-4">Financial Overview</h4>
                         <Image
                    ...
                    <div className="pt-4">
                         <div className="grid lg:grid-cols-5 grid-cols-2 gap-6">
                              ...
                              <div className="">
                                   ...
                                   <h4 className="text-blue-1300 font-inter font-normal text-sm leading-5">€19,950</h4>
                              </div>
                         </div>
                    </div>
               </div>
                    ...
                    <div className="bg-white border border-solid border-gray-1000 rounded-xl p-6">
                         ...
                         <div className="mt-4">
                              <div className="bg-gray-1600 mb-4 rounded-xl p-3">
                                   <h4 className="text-blue-1300 font-inter font-normal text-sm leading-6 mb-2">Property inspection completed. All safety
                                        requirements met.</h4>
                                   <p className="text-gray-1200 font-inter font-normal text-xs leading-4">Admin • Oct 26, 2023 at 02:30 PM</p>
                              </div>
                              <div className="bg-gray-1600 mb-4 rounded-xl p-3">
                                   <h4 className="text-blue-1300 font-inter font-normal text-sm leading-6 mb-2">Owner requested priority listing for Unit 5A.</h4>
                         ...
                         <div className="mt-4">
                              <ul className="relative after:absolute after:content='' after:left-[4.5px] after:top-0 after:bg-gray-1000 after:w-0.5 after:h-[78%]">
                                   <li className="flex items-start gap-8 pb-6 z-10 relative">
                                        ...
                                        <div className="">
                                             <h4 className="text-blue-1300 font-inter font-normal text-sm leading-5 mb-1 ">Property registered</h4>
                                   ...
                                   <li className="flex items-start gap-8 pb-6 z-10 relative">
                                        <span className="bg-blue-2200 rounded-full flex items-center w-3 h-3"></span>
                                        <div className="">
                                             <h4 className="text-blue-1300 font-inter font-normal text-sm leading-5 mb-1 ">Ownership documents verified</h4>
                                   ...
                                   <li className="flex items-start gap-8 pb-6 z-10 relative">
                                        <span className="bg-blue-2200 rounded-full flex items-center w-3 h-3"></span>
                                        <div className="">
                                             <h4 className="text-blue-1300 font-inter font-normal text-sm leading-5 mb-1 ">First listing created (Unit 1A)</h4>
                                   ...
                                   <li className="flex items-start gap-8 pb-6 z-10 relative">
                                        <span className="bg-blue-2200 rounded-full flex items-center w-3 h-3"></span>
                                        <div className="">
                                             <h4 className="text-blue-1300 font-inter font-normal text-sm leading-5 mb-1 ">24 units added</h4>
                                   ...
                                   <li className="flex items-start gap-8 pb-6 z-10 relative">
                                        <span className="bg-blue-2200 rounded-full flex items-center w-3 h-3"></span>
                                        <div className="">
                                             <h4 className="text-blue-1300 font-inter font-normal text-sm leading-5 mb-1 ">Property approved by admin</h4>
                                   ...
                                   <li className="flex items-start gap-8 pb-6 z-10 relative">
                                        <span className="bg-blue-2200 rounded-full flex items-center w-3 h-3"></span>
                                        <div className="">
                                             <h4 className="text-blue-1300 font-inter font-normal text-sm leading-5 mb-1 ">First booking confirmed</h4>
