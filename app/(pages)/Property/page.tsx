          ...
          <div className="font-inter">
               ...
               <div className='bg-white mb-6 xl:flex-nowrap flex-wrap border border-gray-1000/50 rounded-2xl shadow-8xl 2xl:p-6 p-3 flex items-center justify-between gap-3'>
                    <div className='flex items-center gap-4'>
                         ...
                         <div>
                              <h6 className='text-lg font-bold leading-7 text-blue-1300'>Mitte Residences</h6>
                    ...
                    <div className='flex items-center flex-wrap gap-4'>
                         ...
                         <div className='flex items-center gap-3 2xl:px-8 px-4 border-r border-gray-3600'>
                              ...
                              <h6 className="text-sm font-normal leading-5 text-gray-1900"><span className='text-blue-1300 font-bold'>20</span> Total Units</h6>
                         </div>
                         <div className='flex items-center gap-3 2xl:pl-8 pl-4'>
                              <img src="/images/wallet-icon.svg" alt="" />
                              <h6 className="text-sm font-normal leading-5 text-gray-1900"><span className='text-blue-1300 font-bold'>€30,000</span> Deposits Held</h6>
                         </div>
                    </div>
               </div>
               <ListingTable></ListingTable>
               <div className='bg-white border border-gray-3600 mt-4 rounded-[14px] shadow-10xl p-6'>
                    <h6 className="text-lg font-bold text-blue-1300 leading-7 mb-4">Recent Listing Activity</h6>
                    <div className='space-y-4'>
                         <div className='flex items-center gap-3'>
                              ...
                              <div>
                                   <h6 className='text-blue-1300 text-sm'>Listing Created – Unit 4B</h6>
                         ...
                         <div className='flex items-center gap-3'>
                              ...
                              <div>
                                   <h6 className='text-blue-1300 text-sm'>Deposit Received – €1,050 for Unit 1A</h6>
                                   <span className="text-gray-1900 block text-sm">
                                        Jan 15, 2024
                                   </span>
                              </div>
                         ...
                         <div className='flex items-center gap-3'>
                              ...
                              <div>
                                   <h6 className='text-blue-1300 text-sm'>Listing Suspended by Admin – Unit 5A</h6>
                                   <span className="text-gray-1900 block text-sm">
                                        Jan 15, 2024
                                   </span>
                              </div>
                         ...
                         <div className='flex items-center gap-3'>
                              ...
                              <div>
                                   <h6 className='text-blue-1300 text-sm'>Listing Activated – Unit 6D</h6>
                                   <span className="text-gray-1900 block text-sm">
                                        Jan 15, 2024
                                   </span>
                              </div>
               ...
               <ul className='flex gap-4 flex-wrap items-center justify-between mt-8'>
                    <li>
                         <Link href="/" className='text-sm font-normal leading-5 text-blue-1300 py-2 px-4 flex items-center gap-4 bg-gray-1500 border border-gray-3600 rounded-lg'>
