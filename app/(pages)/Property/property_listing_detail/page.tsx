     ...
     return (
          <div className="font-inter">
               <div className="bg-white flex md:flex-row flex-col md:items-center justify-between border border-solid border-gray-3600 rounded-[14px] shadow-10xl xl:pt-5 xl:pb-8 mb-4 xl:px-5.75 p-4">
                    <Link href={""} className="py-3 px-4 rounded-lg hover:bg-gray-1600 text-black-1600 font-inter font-normal text-sm leading-5 inline-flex items-center gap-2">
                    ...
                    <ul className="md:flex grid sm:grid-cols-2 grid-cols-1 items-center gap-3">
                         <li>
                              <Link href="/" className='text-sm justify-center font-normal leading-5 text-black-1600 py-2 px-4 flex items-center gap-4 bg-gray-1500 border border-gray-3600 rounded-lg'>
                                   <Image
               ...
               <div className="bg-white flex md:flex-row flex-col md:gap-0 gap-4 md:items-center justify-between border border-solid border-gray-3600 rounded-[14px] shadow-10xl xl:px-12 xl:pt-8 xl:pb-6 p-4">
                    <h4 className="text-black-1600 gap-4 flex items-center font-inter font-bold xl:text-2xl text-base leading-8">Listing Details <span className="text-blue-2200 font-normal text-xs bg-blue-2200/10 border border-solid border-blue-2200/20 rounded-full h-5.5 px-2.5 inline-flex items-center">Booked</span></h4>
                    <ul className="md:flex grid xl:grid-cols-3 grid-cols-1 items-center gap-3">
                         <li>
                              <Link href="/" className='text-sm font-normal leading-5 text-black-1600 py-1.75 px-3 flex items-center justify-center gap-2 bg-gray-1500 border border-gray-3600 transition-all duration-500 ease-in-out hover:bg-gray-1600 rounded-lg'>
                                   <Image
               ...
               <div className="py-8 2xl:px-6 xl:mt-4">
                    <div className="grid md:grid-cols-2 grid-cols-1 gap-6">
                         <div className="bg-white  border border-solid border-gray-3600 rounded-[14px] shadow-10xl p-6">
                              <div className="flex items-center justify-between border-b border-solid border-gray-1000">
                                   <h4 className="text-black-1600 font-inter font-bold text-lg leading-7 pb-4">Listing Summary</h4>
                                   <Image
                                        src="/images/building-icon2.svg"
                                        alt=""
                                        width={20}
                              ...
                              <div className="pt-4">
                                   <div className="max-w-140 w-full grid grid-cols-2 gap-y-4">
                                        <div className="">
                                             ...
                                             <h4 className="text-black-1600 font-inter font-normal text-sm leading-5">Unit 4B</h4>
                                        </div>
                                        <div className="">
                                             <span className="text-gray-1200 font-inter font-normal text-xs leading-4 mb-1 tracking-[0.3px] block">Unit Type</span>
                                             <h4 className="text-black-1600 font-inter font-normal text-sm leading-5">Studio</h4>
                                        </div>
                                        <div className="">
                                             <span className="text-gray-1200 font-inter font-normal text-xs leading-4 mb-1 tracking-[0.3px] block">Monthly Rent</span>
                                             <h4 className="text-black-1600 font-inter font-normal text-sm leading-5">€1,050</h4>
                                        </div>
                                        <div className="">
                                        ...
                                        <div className="">
                                             ...
                                             <h4 className="text-black-1600 font-inter font-normal text-sm leading-5">Jan 10, 2024</h4>
                                        </div>
                                        <div className="">
                                             <span className="text-gray-1200 font-inter font-normal text-xs leading-4 mb-1 tracking-[0.3px] block">Listing Source</span>
                                             <h4 className="text-black-1600 font-inter font-normal text-sm leading-5">Web Portal</h4>
                                        </div>
                                   </div>
                              </div>
                         </div>
                         <div className="bg-white border border-solid border-gray-3600 rounded-[14px] shadow-10xl p-6">
                              <div className="flex items-center justify-between border-b border-solid border-gray-1000">
                                   <h4 className="text-black-1600 font-inter font-bold text-lg leading-7 pb-4">Tenant Information</h4>
                                   <Image
                              ...
                              <div className="pt-4">
                                   <div className="max-w-140 w-full grid grid-cols-2 gap-y-4 mb-4">
                                        <div className="">
                                             ...
                                             <h4 className="text-black-1600 font-inter font-normal text-sm leading-5">Max Schmidt</h4>
                                        </div>
                                        <div className="">
                                             <span className="text-gray-1200 font-inter font-normal text-xs leading-4 mb-1 tracking-[0.3px] block">Nationality</span>
                                             <h4 className="text-black-1600 font-inter font-normal text-sm leading-5">Germany</h4>
                                        </div>
                                        <div className="">
                                             <span className="text-gray-1200 font-inter font-normal text-xs leading-4 mb-1 tracking-[0.3px] block">Booking Period</span>
                                             <h4 className="text-black-1600 font-inter font-normal text-sm leading-5">Feb 1, 2024 → Jul 31, 2024</h4>
                                        </div>
                                        <div className="">
                                        </div>
                                        <div className="">
                    ...
                    <div className="bg-white mt-6 border border-solid border-gray-3600 rounded-[14px] shadow-10xl p-6">
                         <div className="flex items-center justify-between border-b border-solid border-gray-1000">
                              <h4 className="text-black-1600 font-inter font-bold text-lg leading-7 pb-4">Deposit Overview</h4>
                              <Image
                         ...
                         <div className="pt-4">
                              <div className="grid sm:grid-cols-4 grid-cols-2 gap-6 pb-6">
                                   ...
                                   <div className="">
                                        ...
                                        <h4 className="text-black-1600 font-inter font-normal text-sm leading-5">Jan 14, 2024</h4>
                                   </div>
                                   <div className="">
                                        <span className="text-gray-1200 font-inter font-normal text-xs leading-4 mb-1 tracking-[0.3px] block">Payment Method</span>
                                        <h4 className="text-black-1600 font-inter font-normal text-sm leading-5">Bank Transfer</h4>
                                   </div>
                              </div>
                              <div className="pt-4 border-t border-solid border-gray-1000">
                                   <ul className="flex md:flex-row flex-col md:items-center gap-3">
                                        ...
                                        <li>
                                             <Link href={"#"} className="text-sm font-normal leading-5 text-black-1600 h-10 px-3 flex items-center justify-center gap-2 bg-gray-1600 border border-gray-1600 transition-all duration-500 ease-in-out hover:bg-gray-1600 rounded-[10px]">
                                                  Refund Deposit
                                             </Link>
                                        </li>
                                   </ul>
                    ...
                    <div className="bg-white mt-6 border border-solid border-gray-3600 rounded-[14px] shadow-10xl p-6">
                         <div className="flex items-center justify-between border-b border-solid border-gray-1000">
                              <h4 className="text-black-1600 font-inter font-bold text-lg leading-7 pb-4">Listing Content</h4>
                              <Image
                         ...
                         <div className="pt-4">
                              ...
                              <div className="mt-6">
                                   ...
                                   <p className="text-black-1600 max-w-307.5 w-full font-inter font-normal text-sm leading-[22.8px]">Bright and modern studio apartment located in the heart of Berlin Mitte. This fully furnished unit features high ceilings, large windows with plenty of natural light, and a fully equipped
                              ...
                              <div className="mt-6">
                                   ...
                                   <ul className="flex xl:flex-nowrap flex-wrap items-center gap-3">
                                        <li>
                                             <Link href={"#"} className="text-black-1600 gap-2 bg-gray-1600 font-inter font-normal text-sm leading-5 inline-flex items-center justify-center px-3 h-9 rounded-xl">
                         ...
                         <div className="bg-white border border-solid border-gray-1000 rounded-xl p-6">
                              ...
                              <div className="mt-4">
                                   <div className="bg-gray-1600 mb-4 rounded-xl p-3">
                                        <h4 className="text-black-1600 font-inter font-normal text-sm leading-6 mb-2">Verified property documents - all in order.</h4>
                                        <p className="text-gray-1200 font-inter font-normal text-xs leading-4">Admin • Jan 16, 2024 at 11:45 AM</p>
                                   </div>
                                   <div className="bg-gray-1600 mb-4 rounded-xl p-3">
                                        <h4 className="text-black-1600 font-inter font-normal text-sm leading-6 mb-2">Tenant verification completed successfully.</h4>
                                   ...
                                   <ul className="relative after:absolute after:content='' after:left-[4.5px] after:top-0 after:bg-gray-1000 after:w-0.5 after:h-[78%]">
                                        <li className="flex items-start gap-8 pb-6 z-10 relative">
                                             <span className="bg-blue-2200 rounded-full flex items-center w-3 h-3"></span>
                                              <div className="">
                                                  <h4 className="text-black-1600 font-inter font-normal text-sm leading-5 mb-1 ">Listing created</h4>
                                        ...
                                        <li className="flex items-start gap-8 pb-6 z-10 relative">
                                             <span className="bg-blue-2200 rounded-full flex items-center w-3 h-3"></span>
                                              <div className="">
                                                  <h4 className="text-black-1600 font-inter font-normal text-sm leading-5 mb-1 ">Deposit received (€1,050)</h4>
                                        ...
                                        <li className="flex items-start gap-8 pb-6 z-10 relative">
                                             <span className="bg-blue-2200 rounded-full flex items-center w-3 h-3"></span>
                                              <div className="">
                                                  <h4 className="text-black-1600 font-inter font-normal text-sm leading-5 mb-1 ">Booking confirmed</h4>
                                        ...
                                        <li className="flex items-start gap-8 pb-6 z-10 relative">
                                             <span className="bg-blue-2200 rounded-full flex items-center w-3 h-3"></span>
                                              <div className="">
                                                  <h4 className="text-black-1600 font-inter font-normal text-sm leading-5 mb-1 ">Listing reviewed by admin</h4>
