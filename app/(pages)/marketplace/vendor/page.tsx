                    ...
                    <div>
                         <div className="grid grid-cols-12 gap-6">
                              ...
                              <div className="2xl:col-span-3 xl:col-span-6 col-span-12 space-y-4">
                                   ...
                                   <div className="bg-white border border-gray-1000 p-4 rounded-xl shadow-18xl">
                                        ...
                                        <div className="flex items-center text-sm mb-4 gap-2">
                                             ...
                                             <div className="ml-auto text-end">
                                                  <span className="font-normal text-xs leading-4 font-normal block text-gray-1200"><span className="text-blue-1300 text-lg font-bold">4.7</span> / 5</span>
                                        ...
                                        <div className="border-t border-gray-1000 flex items-center justify-between mt-4 pt-3">
                                             ...
                                             <p className="text-xs text-blue-1300 font-medium">
                                                  March 2023
                                             </p>
                                        </div>
                                   </div>
                                   ...
                                   {/* KYB */}
                                   <div className="bg-white border border-gray-1000 p-4 rounded-xl shadow-18xl">
                                        <div className="flex itesm-center mb-2 gap-2">
                                   ...
                                   <div className="bg-white rounded-xl shadow p-5">
                                        ...
                                        <div className="flex justify-between items-center mb-4">
                                             <div className="flex justify-center gap-2 items-center">
                                                  ...
                                                  <h3 className="font-bold leading-5 text-sm text-blue-1300">
                                                       Product Catalog
                                                  </h3>
                                             </div>
                                        ...
                                        <div className="flex items-center gap-2  mb-4">
                                             ...
                                             <Link href="" className="bg-gray-1600 rounded-md border border-gray-1000 w-8 h-8 flex items-center justify-center">
                                                  <img src="/images/filter.svg" alt="" /></Link>
                                        </div>
                                        {/* Products */}
                                                  ...
                                                  >
                                                       <div className="flex flex-wrap gap-3">
                                                            ...
                                                            <div>
                                                                 ...
                                                                 <div className="flex text-xs gap-4 text-gray-1200 gap-4 mt-1">
                                                                      <span>Price: <span className="text-sm font-bold text-blue-1300">{product.price}</span></span>
                                                                      <span>
                                                                           Commission: <span className="text-sm font-medium text-lightgreen17">{product.commission}</span>
                                                                      </span>
                              ...
                              <div className="2xl:col-span-3 col-span-12 space-y-6">
                                   ...
                                   <div className="border border-gray-1000 bg-white rounded-lg p-3">
                                        ...
                                        <div className="bg-lightgreen17/10 rounded-xl p-4">
                                             <p className="text-xs font-normal mb-1.5 text-gray-1200">
                                                  Total Sales (All Time)
                                             </p>
                                             <div className="flex items-center gap-2">
                                                  <p className="4xl:text-2xl text-xl leading-8 text-blue-1300 font-bold">
                                                       €187,542.80
                                                  </p>
                                   ...
                                   <div className="border border-gray-1000 bg-white rounded-lg p-3">
                                        ...
                                        <div className="bg-lightgreen17/10 mb-4 flex items-start justify-between rounded-xl p-4">
                                             <div>
                                                  ...
                                                  <p className="4xl:text-xl text-lg leading-8 text-lightgreen17 font-bold">
                                                       €12,450.00
                                                  </p>
                                                  <p className="text-xs font-normal  text-gray-1200">
                                                       Feb 15, 2026
                                                  </p>
                                             </div>
                                        ...
                                        <div className="space-y-2">
                                             <p className="text-xs text-gray-1200 font-medium">
                                                  Recent Payouts
                                             </p>
                                             ...
                                             {payouts.map((p) => (
                                                  ...
                                                  >
                                                       <div>
                                                            ...
                                                            <span className="text-gray-1200 block text-[10px] leading-[15px]">
                                                                 {p.date}
                                                            </span>
                                                       </div>
                                                       <span className="text-[10px] h-fit leading-[15px] font-bold text-lightgreen17 rounded-full py-0.5 px-2.5 bg-lightgreen17/10">Completed</span>
                                                  </div>
                                             ))}
                                        </div>
                                   </div>
                                   ...
                                   <div className="border border-gray-1000 bg-white rounded-lg p-3 space-y-2">
                                        <div className="flex itesm-center justify-between">
                                             ...
                                             <div>
                                                  <span
                                                       className={`px-2.5 py-1 rounded-full inline-flex items-center gap-1 text-[10px] text-lightgreen17 bg-lightgreen17/10`}
                                                  >
                                        ...
                                        <div className=" bg-gray-2100/30 rounded-lg p-3">
                                             <div className="pb-3 border-b border-gray-1000">
                                                  ...
                                                  <p className="text-sm font-medium leading-5 text-blue-1300">
                                                       Deutsche Bank
                                                  </p>
                                             </div>
                                        ...
                                        <Link href="/" className="flex items-center gap-4 text-xs font-medium leading-4 text-blue-1300 py-[7px] w-full bg-gray-1600 rounded-md border-gray-1000 justify-center"><img src="/images/payment-icon2.svg" alt="" /> View Payment History</Link>
                                   </div>
                              </div>
                         </div>
                    </div>
