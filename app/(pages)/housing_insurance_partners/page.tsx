            ...
            <div className="max-w-309.5 w-full mx-auto pt-2">
                  <div className="mb-8 flex xl:flex-row flex-col xl:items-center justify-between">
                        <div className="2xl:max-w-full xl:max-w-100 max-w-full 2xl:w-auto w-full xl:mb-0 mb-3">
                              <h4 className="text-black-1200 font-bold 2xl:text-[30px] text-[28px] leading-9 mb-2">Housing & Insurance Partners</h4>
                              <p className="text-gray-1100 font-normal md:text-base text-sm leading-6 xl:max-w-full w-full max-w-full">Manage official housing and insurance service providers connected to StudPay</p>
                        </div>
