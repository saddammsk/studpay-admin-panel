          ...
          <div className='grid 5xl:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-4'>
            <div className='flex items-start justify-between bg-white border border-solid border-gray-3100 shadow-4xl rounded-lg p-4'>
              <div className=''>
                ...
                <div className='flex items-center gap-2 my-1.5'>
                  <h4 className='text-black-1600 font-inter font-semibold md:text-2xl text-lg leading-8'>€12,847.32</h4>
            ...
            <div className='flex items-start justify-between bg-white border border-solid border-gray-3100 shadow-4xl rounded-lg p-4'>
              <div className=''>
                ...
                <h4 className='text-black-1600 font-inter font-semibold md:text-2xl text-lg leading-8 my-1.5'>2 Active</h4>
            ...
            <div className='flex items-start justify-between bg-white border border-solid border-gray-3100 shadow-4xl rounded-lg p-4'>
              <div className=''>
                ...
                <h4 className='text-black-1600 font-inter font-semibold md:text-2xl text-lg leading-8 my-1.5'>1 Open</h4>
            ...
            <div className='flex items-start justify-between bg-white border border-solid border-gray-3100 shadow-4xl rounded-lg p-4'>
              <div className=''>
                ...
                <h4 className='text-black-1600 font-inter font-semibold md:text-2xl text-lg leading-8 my-1.5'>3 Flags</h4>
          ...
          <div className='bg-white mb-4 border border-solid border-gray-3100 shadow-4xl md:p-6 p-4 mt-4 rounded-lg'>
            ...
            <div className='bg-gray-1600/50 mb-2 rounded-lg p-3 flex sm:flex-row flex-col sm:items-center items-start justify-between'>
              <div className='flex items-center gap-3'>
                ...
                <p className='text-black-1600 font-inter font-normal sm:text-sm text-xs leading-5'>Large international transfer detected</p>
              </div>
            ...
            <div className='bg-gray-1600/50 mb-2 rounded-lg p-3 flex sm:flex-row flex-col sm:items-center items-start justify-between'>
              <div className='flex items-center gap-3'>
                <span className='text-red1700 font-inter font-semibold text-[10px] leading-3.75 bg-red1800 border border-solid border-red1700/20 rounded-full h-5.25 px-2.5 uppercase inline-flex items-center justify-center'>high</span>
                <p className='text-black-1600 font-inter font-normal sm:text-sm text-xs leading-5'>Login from new location (Russia)</p>
              </div>
            ...
            <div className='bg-gray-1600/50 mb-2 rounded-lg p-3 flex sm:flex-row flex-col sm:items-center items-start justify-between'>
              <div className='flex items-center gap-3'>
                ...
                <p className='text-black-1600 font-inter font-normal sm:text-sm text-xs leading-5'>Multiple failed card transactions</p>
              </div>
            ...
            <div className='relative after:absolute after:content="" sm:after:left-6.5 after:left-4 after:top-1/2 after:-translate-y-1/2 after:w-0.5 after:h-[85%] after:bg-gray-3100'>
              <div className='flex items-center gap-3 sm:p-3 px-0 py-4 relative z-50'>
                ...
                <div className='flex-1 w-full flex items-start justify-between'>
                  <div className=''>
                    <h4 className='text-black-1600 font-inter font-medium text-sm leading-5'>Salary deposit - ABC Corp</h4>
              ...
              <div className='flex items-center gap-3 sm:p-3 px-0 py-4 relative z-50'>
                ...
                <div className='flex-1 w-full flex items-start justify-between'>
                  <div className=''>
                    <h4 className='text-black-1600 font-inter font-medium text-sm leading-5'>Amazon.de Purchase</h4>
                    <div className='flex items-center gap-2 mt-1'>
                      <p className='text-gray-1900 font-inter font-normal text-xs leading-4'>Today, 14:32</p>
                      <span className='text-lightgreen17 font-inter font-semibold text-[10px] leading-3.75 h-4.25 px-1.5 bg-skyblue2434 border border-solid  border-lightgreen17/20 rounded-full inline-flex items-center justify-center'>completed</span>
                    </div>
                  </div>
                  <span className='text-black-1600 font-inter font-normal sm:text-sm text-xs leading-5 block'>-€89.99</span>
                </div>
              </div>
              <div className='flex items-center gap-3 sm:p-3 px-0 py-4 relative z-50'>
                <span className='bg-gray-1600 w-8 h-8 flex items-center justify-center rounded-full'>
                ...
                <div className='flex-1 w-full flex items-start justify-between'>
                  <div className=''>
                    <h4 className='text-black-1600 font-inter font-medium text-sm leading-5'>Rent transfer - Landlord</h4>
                    <div className='flex items-center gap-2 mt-1'>
                  ...
                  <span className='text-black-1600 font-inter font-normal sm:text-sm text-xs leading-5 block'>-€850.00</span>
                </div>
              </div>
              <div className='flex items-center gap-3 sm:p-3 px-0 py-4 relative z-50'>
                <span className='bg-gray-1600 w-8 h-8 flex items-center justify-center rounded-full'>
                ...
                <div className='flex-1 w-full flex items-start justify-between'>
                  <div className=''>
                    <h4 className='text-black-1600 font-inter font-medium text-sm leading-5'>Apple Pay - Rewe</h4>
                    <div className='flex items-center gap-2 mt-1'>
                      <p className='text-gray-1900 font-inter font-normal text-xs leading-4'>Yesterday, 18:45</p>
                      <span className='text-lightgreen17 font-inter font-semibold text-[10px] leading-3.75 h-4.25 px-1.5 bg-skyblue2434 border border-solid  border-lightgreen17/20 rounded-full inline-flex items-center justify-center'>completed</span>
                    </div>
                  </div>
                  <span className='text-black-1600 font-inter font-normal sm:text-sm text-xs leading-5 block'>-€34.56</span>
                </div>
              </div>
              <div className='flex items-center gap-3 sm:p-3 px-0 py-4 relative z-50'>
                <span className='bg-gray-1600 w-8 h-8 flex items-center justify-center rounded-full'>
                ...
                <div className='flex-1 w-full flex items-start justify-between'>
                  <div className=''>
                    <h4 className='text-black-1600 font-inter font-medium text-sm leading-5'>Savings transfer</h4>
                    <div className='flex items-center gap-2 mt-1'>
                      <p className='text-gray-1900 font-inter font-normal text-xs leading-4'>Yesterday, 20:00</p>
                      <span className='text-lightgreen17 font-inter font-semibold text-[10px] leading-3.75 h-4.25 px-1.5 bg-skyblue2434 border border-solid  border-lightgreen17/20 rounded-full inline-flex items-center justify-center'>completed</span>
                    </div>
                  </div>
                  <span className='text-black-1600 font-inter font-normal sm:text-sm text-xs leading-5 block'>-€200.00</span>
                </div>
              </div>
            </div>
          </div>
