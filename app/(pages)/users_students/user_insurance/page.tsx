    ...
    <div className='font-inter'>
              ...
              <div className='bg-white border border-solid border-gray-1000 rounded-lg shadow-61xl 2xl:p-5 px-2.5 py-4'>
                <div className='flex items-center gap-3 mb-4'>
                  ...
                  <div className='flex-1 w-full flex items-start justify-between'>
                    <div className="">
                      <h4 className='text-blue-1300 font-semibold 2xl:text-sm text-[13px] leading-5'>Health Insurance</h4>
                      <p className='text-gray-1200 font-normal text-xs leading-4'>Mutuelle</p>
                    </div>
                    <div className='inline-flex items-center bg-green55 rounded-full h-6.5 px-2.5 gap-1.5 border border-solid border-lightgreen17/20 text-green54 font-inter font-medium text-xs leading-4'>
                ...
                <ul>
                  <li className='flex mb-2 items-center justify-between text-gray-1200 5xl:text-sm text-xs leading-5 font-normal'>
                    Provider
                    <span className='flex items-center text-blue-1300 font-medium'>LMDE Mutuelle</span>
                  </li>
                  <li className='flex items-center justify-between text-gray-1200 5xl:text-sm text-xs leading-5 font-normal'>
                    Policy Number
                    <span className='flex items-center text-blue-1300 font-medium'>MUT-2024-456789</span>
                  </li>
                </ul>
              </div>
              <div className='bg-white border border-solid border-gray-1000 rounded-lg shadow-61xl 2xl:p-5 px-2.5 py-4'>
                <div className='flex items-center gap-3 mb-4'>
                  ...
                  <div className='flex-1 w-full flex items-start justify-between'>
                    <div className="">
                      <h4 className='text-blue-1300 font-semibold 2xl:text-sm text-[13px] leading-5'>Housing Insurance</h4>
                      <p className='text-gray-1200 font-normal text-xs leading-4'>Multirisque Habitation</p>
                    </div>
                    <div className='inline-flex items-center bg-green55 rounded-full h-6.5 px-2.5 gap-1.5 border border-solid border-lightgreen17/20 text-green54 font-inter font-medium text-xs leading-4'>
                      <span className='flex items-center bg-lightgreen17 rounded-full w-1.5 h-1.5'></span>
                      Active
                ...
                <ul>
                  <li className='flex mb-2 items-center justify-between text-gray-1200 5xl:text-sm text-xs leading-5 font-normal'>
                    Provider
                    <span className='flex items-center text-blue-1300 font-medium'>StudPay Assurance</span>
                  </li>
                  <li className='flex items-center justify-between text-gray-1200 5xl:text-sm text-xs leading-5 font-normal'>
                    Policy Number
                    <span className='flex items-center text-blue-1300 font-medium'>MRH-2024-98765</span>
                  </li>
                </ul>
              </div>
              <div className='bg-white border border-solid border-gray-1000 rounded-lg shadow-61xl 2xl:p-5 px-2.5 py-4'>
                <div className='flex items-center gap-3 mb-4'>
                  ...
                  <div className='flex-1 w-full flex items-start justify-between'>
                    <div className="">
                      <h4 className='text-blue-1300 font-semibold 2xl:text-sm text-[13px] leading-5'>Civil Liability</h4>
                      <p className='text-gray-1200 font-normal text-xs leading-4'>Responsabilité Civile</p>
                    </div>
                    <div className='inline-flex items-center bg-green55 rounded-full h-6.5 px-2.5 gap-1.5 border border-solid border-lightgreen17/20 text-green54 font-inter font-medium text-xs leading-4'>
                      <span className='flex items-center bg-lightgreen17 rounded-full w-1.5 h-1.5'></span>
                      Active
                ...
                <ul>
                  ...
                  <li className='flex items-center justify-between text-gray-1200 5xl:text-sm text-xs leading-5 font-normal'>
                    Policy Number
                    <span className='flex items-center text-blue-1300 font-medium'>RC-2024-12345</span>
                  </li>
                </ul>
              </div>
            </div>
            <div className='bg-white mt-6 border border-solid border-gray-1000 rounded-lg shadow-61xl'>
              <div className='flex sm:flex-row flex-col sm:items-center items-start sm:gap-0 gap-4 justify-between py-4 px-5 border-b border-solid border-gray-1000'>
                <div className='flex items-center gap-2.5'>
                  ...
                  <h4 className="text-blue-1300 font-semibold text-sm leading-5">Insurance Documents & Certifications</h4>
                </div>
                <Link href={"#"} className='flex items-center justify-center bg-white-1100 border border-solid border-gray-1000 rounded-md h-9 px-3 text-sm leading-5 font-medium'>
                  <Image
              ...
              <div className='bg-white  border border-solid border-gray-1000 rounded-lg shadow-61xl'>
                <div className='flex items-center justify-between py-4 px-5 border-b border-solid border-gray-1000'>
                  <div className='flex items-center gap-2.5'>
                    ...
                    <h4 className="text-blue-1300 font-semibold text-sm leading-5">Insurance Claims</h4>
                  </div>
                  <span className="text-gray-1200 font-normal text-xs leading-4">2 claims</span>
                </div>
                <div className='p-5'>
                  <div className='bg-gray-1600/30 mb-3 flex items-center justify-between border border-solid border-gray-1000 rounded-lg p-4'>
                    <div className=''>
                      <h4 className='text-blue-1300 font-medium text-sm leading-5'>Medical Consultation</h4>
                      <p className='text-gray-1200 font-normal text-xs leading-4'>CLM-2024-001 • Dec 15, 2024</p>
                    </div>
                    <div className='text-right'>
                      <h4 className='text-blue-1300 font-semibold text-sm leading-5'>€45</h4>
                      <span className='text-xs leading-4 font-normal text-lightgreen17 flex items-center gap-2'>
                        <Image
                  ...
                  <div className='bg-gray-1600/30 flex items-center justify-between border border-solid border-gray-1000 rounded-lg p-4'>
                    <div className=''>
                      <h4 className='text-blue-1300 font-medium text-sm leading-5'>Prescription Medication</h4>
                      <p className='text-gray-1200 font-normal text-xs leading-4'>CLM-2024-002 • Jan 8, 2025</p>
                    </div>
                    <div className='text-right'>
                      <h4 className='text-blue-1300 font-semibold text-sm leading-5'>€28</h4>
                      <span className='text-xs leading-4 font-normal text-yellow-1100 flex items-center gap-2'>
                        <Image
              ...
              <div className='bg-white  border border-solid border-gray-1000 rounded-lg shadow-61xl'>
                <div className='flex items-center justify-between py-4 px-5 border-b border-solid border-gray-1000'>
                  <div className='flex items-center gap-2.5'>
                    ...
                    <h4 className="text-blue-1300 font-semibold text-sm leading-5">Premium Payments</h4>
                  </div>
                  <Link href={"#"} className="text-green54 block font-semibold text-xs leading-4">All Paid</Link>
                </div>
                <div className='p-5'>
                  <div className='bg-gray-1600/30 mb-3 flex items-center justify-between border border-solid border-gray-1000 rounded-lg p-4'>
                    <div className='flex items-center gap-3'>
                      <span className='bg-green55 rounded-full w-8 h-8 flex items-center justify-center'>
                        <Image
                          src="/icons/check-icon3.svg"
                          width="16"
                          height="16"
                      ...
                      <div className=''>
                        <h4 className='text-blue-1300 font-medium text-sm leading-5'>January 2025</h4>
                        <p className='text-gray-1200 font-normal text-xs leading-4'>Jan 1, 2025 • Direct Debit</p>
                      </div>
                    </div>
                    <h4 className='text-blue-1300 font-semibold text-sm leading-5'>€42</h4>
                  </div>
                  <div className='bg-gray-1600/30 mb-3 flex items-center justify-between border border-solid border-gray-1000 rounded-lg p-4'>
                    <div className='flex items-center gap-3'>
                      <span className='bg-green55 rounded-full w-8 h-8 flex items-center justify-center'>
                      ...
                      <div className=''>
                        <h4 className='text-blue-1300 font-medium text-sm leading-5'>December 2024</h4>
                        <p className='text-gray-1200 font-normal text-xs leading-4'>Dec 1, 2024 • Direct Debit</p>
                      </div>
                    </div>
                    <h4 className='text-blue-1300 font-semibold text-sm leading-5'>€42</h4>
                  </div>
                  <div className='bg-gray-1600/30 flex items-center justify-between border border-solid border-gray-1000 rounded-lg p-4'>
                    <div className='flex items-center gap-3'>
                      ...
                      <div className=''>
                        <h4 className='text-blue-1300 font-medium text-sm leading-5'>November 2024</h4>
                        <p className='text-gray-1200 font-normal text-xs leading-4'>Nov 1, 2024 • Direct Debit</p>
                      </div>
                    </div>
                    <h4 className='text-blue-1300 font-semibold text-sm leading-5'>€42</h4>
                  </div>
            ...
            <div className='bg-white mt-6 border border-solid border-gray-1000 rounded-lg shadow-61xl'>
              <div className='flex items-center justify-between py-4 px-5 border-b border-solid border-gray-1000'>
                <div className='flex items-center gap-2.5'>
                  ...
                  <h4 className="text-blue-1300 font-semibold text-sm leading-5">Admin Control Actions</h4>
                </div>
              </div>
                ...
                <div className='grid sm:grid-cols-3 grid-cols-1 gap-3 mt-4'>
                  <Link href={"#"} className='bg-white-1100 flex items-center justify-center flex-col rounded-md border border-solid border-lightgreen17/30 text-center py-4 5xl:px-2 px-1'>
                    <Image
                      ...
                      alt=''
                    />
                    <h4 className='text-blue-1300 text-sm leading-5 font-medium mt-2'>Renew Policy</h4>
                    <p className='text-gray-1200 text-xs leading-4 font-medium'>Next academic year</p>
                  </Link>
                  ...
                  <Link href={"#"} className='bg-white-1100 flex items-center justify-center flex-col rounded-md border border-solid border-gray-1000 text-center py-4 5xl:px-2 px-1'>
                    <Image
                      ...
                      alt=''
                    />
                    <h4 className='text-blue-1300 text-sm leading-5 font-medium mt-2'>Support Liaison</h4>
                    <p className='text-gray-1200 text-xs leading-4 font-medium'>Contact provider</p>
                  </Link>
                </div>
              </div>
            </div>
      ...
      >
        ...
        <div className='md:py-8.5 md:px-6 p-4'>
          <h4 className='text-black-2000 font-semibold text-lg leading-5 tracking-[-0.45px]'>Terminate Insurance Policies</h4>
          <p className='text-gray-1900 font-normal text-sm leading-5 mt-1.5'>
            This action will cancel all your active insurance policies. Any remaining premium balance will be refunded within 30 business days. This is typically done when leaving the country.
          </p>
