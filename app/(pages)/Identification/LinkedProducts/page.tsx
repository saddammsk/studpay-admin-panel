                         ...
                         <div className="px-6 pb-6">
                              <ul>
                                   <li className="flex items-center justify-between mb-4">
                                        <p className="text-gray-1200 font-normal font-segoe leading-4">Balance</p>
                                        <span className="font-normal font-segoe leading-4 block text-black13">$2,450.75</span>
                                   </li>
                                   <li className="flex items-center justify-between mb-4">
                                        <p className="text-gray-1200 font-normal font-segoe leading-4">Wallet ID</p>
                                        <span className="font-normal font-segoe leading-4 block text-black13">STUW_345234</span>
                                   </li>
                                     <li className="flex items-center justify-between mb-4">
                                        <p className="text-gray-1200 font-normal font-segoe leading-4">Status</p>
                              ...
                              <Link href={"#"} className="flex items-center justify-center text-black13 font-segoe font-normal text-[13.89px] leading-5 border border-solid border-gray1600 rounded-md h-10">Manage Wallet</Link>
                         </div>
                    </div>
               </div>
          </div>
