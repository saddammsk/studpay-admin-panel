        ...
        <div className="bg-white border border-solid border-grey5800 mt-7 rounded-lg shadow-4xl">
          ...
          <div className="sm:px-5 px-4 py-4 border-b border-solid border-grey5800 relative">
            <div className="flex items-start gap-2">
              <span className="text-xs leading-4 font-semibold uppercase text-blue1700 w-8.5 h-8.5 bg-lighrgrey36 rounded-full flex items-center justify-center border border-solid border-grey5800">
                AK
              </span>
              <div className="flex-1 w-full">
                <div className="flex items-center gap-2">
                  <h4 className="text-blue1700 text-base leading-5 font-medium">
                    Ahmed Khan
                  </h4>
                ...
                <ul className="flex flex-wrap items-center gap-2 mt-1">
                  <li className="text-gray-5000 text-xs leading-4 font-normal">
                    ahmed@db.pk
                  </li>
                  <li className="text-gray-5000 text-xs leading-4 font-normal">
                    ·
