...
import { MapPin, Smartphone, Wifi, Bell, Headphones, Users } from "lucide-react";
import StepFlow, { StepItem } from "@/app/components/StepFlow";
import CustomSelect from "@/app/components/CustomSelect";
import { useInactivityRulesStore } from "@/app/store/zustand/useInactivityRulesStore";
...
function InactivityRule() {
  const {
    ...
    simulatorTargetUser,
    setSimulatorTargetUser,
  } = useInactivityRulesStore();
        ...
        <div className="bg-white border border-gray-1000 rounded-xl shadow-4xl md:p-6 p-2.5">
          <div className="flex items-center md:flex-nowrap flex-wrap gap-4 justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h6 className="md:text-2xl text-xl font-bold leading-8 text-black-1600">
                  StudSafe — Inactivity Rules
                </h6>
                <p className="text-sm font-normal leading-5 text-gray-1200">
                  Smart Safety Automation Engine
                </p>
              </div>
            </div>
            <div className="border border-gray-1000 flex-wrap px-4 py-2 bg-gray-1600 rounded-xl flex items-center gap-3">
              ...
              <ToggleSwitch enabled={globalAutomation} setEnabled={setGlobalAutomation} />
              <div className="text-white text-xs font-bold leading-4 px-2.5 py-0.5 rounded-full bg-green-1500">
                Active
              </div>
            </div>
          </div>
          <div className="flex mt-6 flex-wrap items-center justify-start md:gap-3 gap-1">
            ...
            <div className="bg-white border border-gray-1000 rounded-xl py-2 px-4 flex items-center gap-3">
              <h6 className="text-sm font-normal leading-5 text-black-1600">
                Standard Europe Policy
              </h6>
              <div className="text-xs font-bold leading-4 text-black-1600 py-0.5 px-2.5 rounded-full border border-gray-1000 rounded-full">
                4 rules
              </div>
          ...
          <div className="bg-white border border-gray-1000 rounded-xl shadow-4xl 2xl:p-6 p-4">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs font-normal leading-4 text-gray-1200">
                  Define inactivity thresholds and trigger conditions
                </p>
              </div>
            </div>
            <div className="border border-gray-1000 mb-6 rounded-xl bg-gray-1600/50 md:p-6 p-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-xs font-bold leading-4 text-black-1600 py-0.5 px-2.5 rounded-full border border-gray-1000">
                    6:00 AM — 10:00 PM
                  </div>
                </div>
            ...
            <div className="border border-gray-1000 mb-6 rounded-xl bg-gray-1600/50 md:p-6 p-3">
              <div className="flex items-center justify-between">
                ...
                <span className="md:text-2xl text-xl font-bold leading-8 text-yellow-2500">
                  15 min
                </span>
              </div>
              <TimeRangeSlider />
          ...
          <div>
            ...
            <div className="bg-white border border-gray-1000 rounded-xl shadow-4xl 2xl:p-6 p-4 mb-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h6 className="text-lg font-bold leading-7 text-black-1600">
                    Escalation Workflow
                  </h6>
                  <p className="text-xs font-normal leading-4 text-gray-1200">
                    Step-by-step response when a rule is triggered
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white border border-gray-1000 rounded-xl shadow-4xl p-6 mb-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs font-normal leading-4 text-gray-1200">
                    Test your rules before deploying to production
                  </p>
                </div>
              </div>
              <div className="rounded-xl bg-gray-1600/50 border border-gray-1000 p-4">
                <h6 className="text-sm font-normal leading-5 mb-3 text-black-1600">
                  Scenario Injector
                </h6>
                <div className="grid md:grid-cols-2 mb-4 gap-3 max-w-[452px]">
                  <div>
                    <label className="block mb-1.5 text-xs font-normal leading-4 text-gray-1200">
                      Scenario
                    </label>
                    <CustomSelect
                      className="bg-white rounded-[10px]! border border-gray-1000"
                  ...
                  <div>
                    ...
                    <CustomSelect
                      className="bg-white rounded-[10px]! border border-gray-1000"
                      value={simulatorTargetUser}
                      onChange={(e) => setSimulatorTargetUser(e.target.value)}
                      options={[
                ...
                <Link
                  href="/"
                  className="flex items-center gap-2 px-4 py-3 text-sm font-normal leading-5 text-white w-fit bg-yellow-2500 rounded-[10px]"
                >
                  <img src="/images/play-icon.svg" alt="" /> Test Rule
                </Link>
              </div>
            </div>
          </div>
