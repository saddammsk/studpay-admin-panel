               ...
               <div className="p-6 -mt-11.25">
                    <div className="bg-white flex flex-wrap gap-4 items-center justify-between py-3 px-5">
                         <div className="flex items-center flex-wrap gap-2">
                              ...
                              <div className="pr-4">
                                   <h6 className="text-sm font-bold leading-3.5 text-blue-3300">StudSafe</h6>
                                   <p className="text-[10px] font-normal leading-3.75 text-gray-5400">Live Monitoring</p>
                              </div>
                              <div className="bg-gray-5500 h-8 w-px block"></div>
                         ...
                         <form action="" className="flex flex-wrap justify-end 2xl:flex-1 items-center gap-3">
                              ...
                              <Link href="/" className="text-xs font-normal leading-3 text-blue-3300 px-3.5 py-1.75 bg-gray-5200 rounded-[10px]">All Cities</Link>
                              <Link href="/" className="text-xs font-normal leading-3 text-blue-3300 px-3.5 py-1.75 bg-gray-5200 rounded-[10px]">All Statuses</Link>
                              <Link href="/" className="text-xs font-normal leading-3 text-gray-5400 px-3.5 py-1.75 bg-gray-5200 rounded-[10px] flex items-center gap-1"><img src="/images/wallet-icon5.svg" alt="" /> &lt; 15%</Link>
                         </form>
                    </div>
