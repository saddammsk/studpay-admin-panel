...
const KycDocumentPage = () => {
      ...
      return (
            <div>
                 <div>
                        <h4 className="text-black12 font-bold md:text-[30px] text-2xl leading-9 mb-2">KYC & Documents</h4>
                        <p className="text-gray-1100 font-normal md:text-base text-sm leading-6">Review and approve student document submissions</p>
                  </div>
