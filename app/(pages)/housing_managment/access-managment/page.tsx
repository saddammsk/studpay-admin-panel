          ...
          <div className="font-inter">
               ...
               <div className='my-8 grid xl:grid-cols-5 sm:grid-cols-3 grid-cols-2 4xl:gap-[54px] 2xl:gap-8 gap-3'>
                    <div className='bg-white border border-gray-1000/50 rounded-2xl shadow-8xl md:p-5 p-3'>
                         ...
                         <span className="text-[30px] leading-9 font-bold text-blue-1300 block">192</span>
                    </div>
                    <div className='bg-white border border-gray-1000/50 rounded-2xl shadow-8xl md:p-5 p-3'>
                         <div className='flex items-start justify-between mb-4'>
                              <div className='bg-blue-1700/10 rounded-xl w-11 h-11 flex items-center justify-center'>
                         ...
                         <span className="text-[30px] leading-9 font-bold text-blue-1300 block">84</span>
                    </div>
                    <div className='bg-white border border-gray-1000/50 rounded-2xl shadow-8xl md:p-5 p-3'>
                         <div className='flex items-start justify-between mb-4'>
                         ...
                         <span className="text-[30px] leading-9 font-bold text-blue-1300 block">142</span>
                    </div>
                    <div className='bg-white border border-gray-1000/50 rounded-2xl shadow-8xl md:p-5 p-3'>
                         <div className='flex items-start justify-between mb-4'>
                         ...
                         <span className="text-[30px] leading-9 font-bold text-blue-1300 block">€45.2k</span>
                    </div>
                    <div className='bg-white border border-gray-1000/50 rounded-2xl shadow-8xl md:p-5 p-3'>
                         <div className='flex items-start justify-between mb-4'>
                         ...
                         <span className="text-[30px] leading-9 font-bold text-blue-1300 block">23</span>
                    </div>
               </div>
               <div className='grid xl:grid-cols-2 gap-6 mb-8'>
                    <div className='bg-white border border-gray-1000/50 rounded-2xl shadow-8xl p-6'>
                         <div className='flex items-start justify-between mb-8'>
                              <div>
                                   <h6 className='text-lg font-bold leading-7 text-blue-1300 mb-0.5'>Properties by Status</h6>
                                   <span className="text-sm font-normal leading-5 text-gray-1200">Click to filter listings</span>
                              </div>
                              <h6 className='text-2xl font-bold leading-8 text-blue-1300'>192</h6>
                         </div>
                    ...
                    <div className='bg-white border border-gray-1000/50 rounded-2xl shadow-8xl p-6 '>
                         <div className='flex items-start justify-between mb-6'>
                              <div>
                                   <h6 className='text-lg font-bold leading-7 text-blue-1300'>Deposits Overview</h6>
                                   <span className="text-sm font-normal leading-5 text-gray-1200">Click to view details</span>
                              </div>
                              <div className="text-end">
                                   <span className="text-sm font-normal leading-5 text-gray-1200">Click to view details</span>
                                   <h6 className='text-2xl font-bold leading-8 text-blue-1300'>€82,000.00</h6>
                              </div>
                         </div>
                         <div className='flex items-center md:flex-nowrap flex-wrap md:gap-14 gap-5 mb-4 justify-between'>
                              <div className='flex items-center gap-4'>
                                   ...
                                   <div>
                                        <h6 className='text-sm font-normal leading-5 text-blue-1300 '>Held</h6>
                              ...
                              <div className="text-end md:flex-1 md:w-auto w-full">
                                   <span className='block text-lg font-bold leading-7 mb-3 text-blue-1300'>€45,200.00</span>
                                   <div className=''>
                         ...
                         <div className='flex items-center md:flex-nowrap flex-wrap md:gap-14 gap-5 mb-4 justify-between'>
                              <div className='flex items-center gap-4'>
                                   ...
                                   <div>
                                        <h6 className='text-sm font-normal leading-5 text-blue-1300 '>Released</h6>
                              ...
                              <div className="text-end md:flex-1 md:w-auto w-full  md:max-w-[522px] ml-auto">
                                   <span className='block text-lg font-bold leading-7 mb-3 text-blue-1300'>€28,500.00</span>
                                   <div className=''>
                         ...
                         <div className='flex items-center md:flex-nowrap flex-wrap md:gap-14 gap-5 mb-4 justify-between'>
                              <div className='flex items-center gap-4'>
                                   ...
                                   <div>
                                        <h6 className='text-sm font-normal leading-5 text-blue-1300 '>Refunded</h6>
                                        <span className="text-xs font-normal leading-4 text-gray-1200">Returned to tenants</span>
                                   </div>
                              </div>
                              <div className="text-end md:flex-1 md:w-auto w-full md:max-w-[522px] ml-auto">
                                   <span className='block text-lg font-bold leading-7 mb-3 text-blue-1300'>€8,300.00</span>
                                   <div className=''>
               ...
               <div className='bg-white border border-gray-1000/50 rounded-2xl shadow-8xl md:p-6 p-4'>
                    <div className='flex items-start justify-between mb-8'>
                         <div>
                              <h6 className='text-lg font-bold leading-7 text-blue-1300 mb-0.5'>Recent Activity</h6>
                    ...
                    <div className='flex items-center justify-between md:flex-nowrap flex-wrap md:gap-0 gap-4 md:p-3 py-2'>
                         <div className='flex items-center gap-4'>
                              ...
                              <div className='flex-1'>
                                   <h6 className="text-sm font-normal leading-5 text-blue-1300">New Property Submitted</h6>
                    ...
                    <div className='flex items-center justify-between md:flex-nowrap flex-wrap md:gap-0 gap-4 md:p-3 py-2'>
                         <div className='flex items-center gap-4'>
                              ...
                              <div className='flex-1'>
                                   <h6 className="text-sm font-normal leading-5 text-blue-1300">Listing Approved</h6>
                    ...
                    <div className='flex items-center justify-between md:flex-nowrap flex-wrap md:gap-0 gap-4 md:p-3 py-2'>
                         <div className='flex items-center gap-4'>
                              ...
                              <div className='flex-1'>
                                   <h6 className="text-sm font-normal leading-5 text-blue-1300">Deposit Received</h6>
                    ...
                    <div className='flex items-center justify-between md:flex-nowrap flex-wrap md:gap-0 gap-4 md:p-3 py-2'>
                         <div className='flex items-center gap-4'>
                              ...
                              <div className='flex-1'>
                                   <h6 className="text-sm font-normal leading-5 text-blue-1300">New Landlord Registered</h6>
                    ...
                    <div className='flex items-center justify-between md:flex-nowrap flex-wrap md:gap-0 gap-4 md:p-3 py-2'>
                         <div className='flex items-center gap-4'>
                              ...
                              <div className='flex-1'>
                                   <h6 className="text-sm font-normal leading-5 text-blue-1300">Listing Rejected</h6>
                                   <h6 className="text-xs font-normal leading-4 text-gray-1200">John Murphy submitted verification documents</h6>
                              </div>
                         </div>
                         <span className="text-xs font-normal leading-4 text-gray-1200">5 min ago</span>
