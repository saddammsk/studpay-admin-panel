          ...
          <>
               <div className="border border-gray-200 overflow-x-auto">
                    <table className="xl:w-full w-300">
                         ...
                         <tbody>
                              {incidents.map((item) => (
                                   <tr onClick={() => setIsOpen(true)} key={item.id} className="border-b border-gray-100">
                                        {/* ID & Severity */}
               ...
               >
                    ...
                    <div className="flex items-center justify-between px-5 py-4 border-b border-gray-5600">
                         <div className="flex items-center gap-2">
                              <h4 className="text-sm font-bold font-JetBrainsMono text-Black235">INC-2401</h4>
                              ...
                              <span className="inline-flex items-center justify-center text-xs px-2 h-5 rounded bg-red-500 text-white-1100 font-normal">
                                   New
                              </span>
                         </div>
                    </div>
                    ...
                    <div className="px-5 py-4 border-b border-gray-5600">
                         ...
                         <div className="grid grid-cols-2 gap-2 mt-3">
                              ...
                              <div className="bg-gray-5800 rounded px-2.5 py-1.5">
                                   <div className="text-xs leading-4 text-gray-2300 font-normal">Trigger</div>
                              ...
                              <div className="bg-gray-5800 rounded px-2.5 py-1.5">
                                   <div className="text-xs leading-4 text-gray-2300 font-normal">Location</div>
                                   <div className="text-xs leading-4 font-normal text-Black235">
                                        Lyon, France
                                   </div>
                              </div>
                              ...
                              <div className="bg-gray-5800 rounded px-2.5 py-1.5">
                                   <div className="text-xs leading-4 text-gray-2300 font-normal">Last Activity</div>
                                   <div className="text-xs leading-4 font-normal text-Black235">
                                        3 min ago
                                   </div>
                              </div>
                              ...
                              <div className="bg-gray-5800 rounded px-2.5 py-1.5">
                                   <div className="text-xs leading-4 text-gray-2300 font-normal">Assignee</div>
                                   <div className="text-xs leading-4 font-normal text-Black235">
                                        Agent Moreau
                                   </div>
                              </div>
                    ...
                    <div className="px-5 py-4 border-b border-gray-200">
                         ...
                         <h4 className="text-gray-2300 text-xs leading-4 font-bold flex items-center gap-1.5 uppercase">
                              <Image src="/images/clock-gray.svg" width={14} height={14} alt="" /> TIMELINE OF EVENTS
                         </h4>
                         ...
                         <div className="relative pl-1 mt-3">
                              ...
                              <div className="">
                                   {timeline.map((item, i) => (
                                        <div key={i} className="relative flex gap-4 pt-1.5 mb-3 last:mb-0">
                    ...
                    <div className="px-5 py-4 border-b border-gray-200">
                         ...
                         <div className="grid grid-cols-3 gap-2 mt-3"> 
                              <button className="flex items-center justify-center hover:bg-gray-5600 h-9 text-Black235 font-normal sm:text-xs text-[10px] leading-4 gap-1.5 bg-gray-1800 border border-solid border-gray-5600 rounded-md w-full">
                                   <Image src="/icons/call-icon.svg" width={16} height={16} alt="" />
                                   Call Student
                              </button>
                              ...
                              <button className="flex items-center justify-center h-9 text-white font-normal sm:text-xs text-[10px] leading-4 gap-1.5 bg-red-2200 hover:bg-red-2200/90 border border-solid border-red-2200 rounded-md w-full">
                                  <Image src="/images/Emergency.svg" width={16} height={16} alt="" />
                                   Emergency
                              </button>
                    ...
                    <div className="px-5 py-4">
                         <button className="w-full bg-blue-1000 h-9 text-white text-sm leading-5 rounded-md hover:bg-blue-1000/90">
                              Resolve Incident
                         </button>
                    </div>
