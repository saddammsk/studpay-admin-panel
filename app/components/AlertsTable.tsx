                         ...
                         <tbody>
                              {alerts.map((alert) => (
                                   ...
                                   >
                                        ...
                                        {/* Action */}
                                        <td className="px-4 py-4">
                                             <button onClick={() => setIsOpen(true)} className="px-3 py-1.5 text-sm flex items-center  text-blue-1300 bg-blue-1300/5 gap-1.5 border rounded-md border-blue-1300/20 transition">
               ...
               >
                    ...
                    <div className='bg-blue-1300/10 rounded-t-xl flex items-center gap-3 px-5 py-4'>
                         ...
                         <div className="">
                              ...
                              <p className='text-gray-1900 font-inter font-normal text-sm leading-5'> Alert ID: ALT-001 </p>
                         </div>
                    </div>
                    <div className="px-2 py-2">
                         ...
                         <div className="border-b border-solid border-gray-3600 py-1">
                              <div className="flex items-center gap-3 py-3 px-6 rounded-lg hover:bg-red-1300/10 mb-1">
                                   <span className="w-5 h-5 flex items-center justify-center">
                              ...
                              <div className="flex items-center gap-3 py-3 px-6 rounded-lg hover:bg-green-1600/10 mb-1">
                                   <span className="w-5 h-5 flex items-center justify-center">
                              ...
                              <div className="flex items-center gap-3 py-3 px-6 rounded-lg hover:bg-blue-1300/10">
                                   <span className="w-5 h-5 flex items-center justify-center">
                         ...
                         <div className="py-1">
                              <div className="flex items-center gap-3 py-3 px-6 rounded-lg hover:bg-gray-6100/10 mb-1">
                                   <span className="w-5 h-5 flex items-center justify-center">
                              ...
                              <div className="flex items-center gap-3 py-3 px-6 rounded-lg hover:bg-yellow-1100/10">
                                   <span className="w-5 h-5 flex items-center justify-center">
                         ...
                         <div className="border-t border-solid border-gray-3600 py-3 px-4 bg-gray-6100/30">
                          <Link onClick={() => setIsOpen(false)} href={"#"} className="px-4 cursor-pointer hover:bg-blue1900 hover:text-blue2000 transition-all duration-500 ease-in-out w-full border rounded-[10px] text-blue-1300 font-medium text-sm leading-5 bg-white-1100 border-solid border-gray-3600 h-9 flex items-center justify-center">Cancel</Link>
                         </div>
                    </div> 
               </Modal>
          </>
