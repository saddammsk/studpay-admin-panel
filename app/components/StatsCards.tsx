...
const colorStyles = {
     red: {
          border: "border-red-1300/30",
          bg: "bg-red-1300/10",
          text: "text-red-1300",
     },
     orange: {
          border: "border-yellow-1100/30",
          bg: "bg-yellow-1100/10",
          text: "text-yellow-1100",
     },
     gray: {
          border: "border-gray-3600",
          bg: "bg-gray-6100",
          text: "text-blue-1300",
     },
     green: {
          border: "border-green-1600/30",
          bg: "bg-green-1600/10",
          text: "text-green-1600",
     },
};
...
const StatCard: React.FC<CardProps> = ({
     ...
     return (
          <div
               className={`rounded-xl border ${styles.border} bg-white p-5 shadow-sm flex justify-between`}
          >
               <div>
                    <p className="text-sm leading-5 text-gray-1900">{title}</p>
                    <h2 className={`text-[30px] font-bold mt-1 ${styles.text}`}>
                         {value}
                    </h2>
                    ...
                    {change && (
                         <p
                              className={`text-sm mt-2 ${changeType === "up" ? "text-green-600" : "text-red-600"
                                   }`}
                         >
               ...
               <div
                    className={`h-10 w-10 flex items-center justify-center rounded-lg ${styles.bg}`}
               >
